...
public class OperacionesSQLPreview {
    ...
    public static void main(String[] args) {
        ...
        try (Connection conn = DriverManager.getConnection(URL, USER, PASSWORD)) {
            ...
            op.estudiantesPorCasa("Gryffindor");
            op.mascotaDeEstudiante("Hermione", "Granger");
            op.numeroEstudiantesPorCasa();
            op.insertarAsignatura("Programación Mágica", "Aula 5B", 1);
            op.modificarAula(10, "Aula 9A");
            op.eliminarAsignatura(10);
    ...
    private static void loadDatabaseProperties() {
        ...
        try (InputStream input = OperacionesSQLPreview.class.getClassLoader().getResourceAsStream("db.properties")) {
